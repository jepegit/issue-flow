...
CONFIG_KEYS: dict[str, ConfigKeySpec] = {
    ...
    "cleanup_yes_a1": ConfigKeySpec("bool"),
    "cleanup_yes_a2": ConfigKeySpec("bool"),
    ...
    "cycle_nonyolo": ConfigKeySpec("enum", ALLOWED_CYCLE_NONYOLO),
    ...
    "defer_changelog": ConfigKeySpec("bool"),
...
def parse_config_value(key: str, raw: str) -> Any:
    ...
    if spec.kind == "enum":
        ...
        elif key == "cycle_nonyolo":
            normalized = normalize_cycle_nonyolo(text)
